...
const Card = () => {
  return (
    <div className={`${styles.container} bg-[var(--bgSoft)] p-[20px] rounded-[10px] flex cursor-pointer w-[100%] hover:bg-[#2e374a] hover:duration-100  hover:ease-in hover:scale-[103%] gap-[10px]`}>
